...
/**
 * localStorage
 * Armazenamento no browser, que é persistido mesmo quando este (browser) é fechado
 * Apenas consegue armazenar strings, logo é necessário o uso de JSON.stringify e JSON.parse
 */
